...
{  empolyee &&   empolyee.map((item, i)=>{
  ...
  return  <div key={i} className="grid sm:grid-cols-3">
  ...
  <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
    ...
    <p className="mb-4 text-xs font-bold text-[orange]">{item.designition}</p>
    <p className="mb-4 text-sm tracking-wide text-white opacity-70">
{item.desc}    </p>
    <div className="flex items-center space-x-3">
      ...
      <a
        href="/"
        className="text-[#b3b2b2] transition-colors duration-300 hover:text-deep-purple-accent-400"
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
